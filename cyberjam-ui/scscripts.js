...
document.getElementById('updateRoleScoreForm').addEventListener('submit', async (event) => {
    ...
    try {
        ...
        document.getElementById('updateRoleScoreOutput').textContent = 'Error updating role score';
    }
});
...
document.getElementById('updateThemeScoreForm').addEventListener('submit', async (event) => {
    ...
    try {
        ...
        document.getElementById('updateThemeScoreOutput').textContent = 'Error updating theme score';
    }
});